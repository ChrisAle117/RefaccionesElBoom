...
export function DetailsPurchase({ product }: DetailsPurchaseProps) {
    ...
    return (
        <div className="flex flex-col gap-4 w-full pt-4 px-2 sm:px-0">
            <div className="relative w-full h-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md flex flex-col p-4 sm:p-6 lg:p-8 space-y-5 sm:space-y-6">
                ...
                <div className="flex items-center mb-6">
                    <button
                        className="w-full sm:w-auto bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 p-3 sm:px-8 rounded-xl shadow-md border-2 border-gray-300 dark:border-gray-500 transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-3 cursor-pointer group"
                        onClick={() => window.location.href = '/dashboard'}
                        type="button"
                    >
                        <ArrowLeft className="w-6 h-6 sm:w-8 sm:h-8 text-red-600 dark:text-red-500 group-hover:-translate-x-1 transition-transform" />
                        <span className="font-black text-xl sm:text-2xl text-gray-800 dark:text-white uppercase">Regresar al catálogo</span>
                    </button>
                </div>
                ...
                <div className="flex justify-between items-start border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h2 className="text-xl sm:text-2xl lg:text-3xl font-black text-gray-800 dark:text-white uppercase">
