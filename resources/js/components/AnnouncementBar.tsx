...
export default function AnnouncementBar() {
    const message = "REFACCIONES DE CALIDAD PARA TU TRACTOCAMIÓN · EN TU TIENDA EN LINEA DE CONFIANZA · ENVÍO GRATIS APARTIR DE $1000 · EN TU TIENDA EN LINEA DE CONFIANZA · ¡LLAMA O ESCRIBE AHORA! ·";
