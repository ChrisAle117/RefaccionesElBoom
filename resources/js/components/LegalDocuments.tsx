...
export function LegalDocuments() {
    ...
    return (
        <div className="max-w-6xl mx-auto bg-white dark:bg-gray-900">
            <h2 className="text-2xl font-bold mb-6 text-rblack dark:text-[#FBCC13]">Documentos Legales</h2>
            
            {/* Selector de documento */}
            <div className="flex mb-8 border-b border-gray-300 dark:border-gray-700">
                <button
                    onClick={() => handleDocumentChange('privacy')}
                    className={`py-2 px-6 font-medium text-sm transition-colors cursor-pointer ${
                ...
                {/* <button
                    onClick={() => handleDocumentChange('returns')}
                    className={`py-2 px-6 font-medium text-sm transition-colors cursor-pointer ${
                    ...
                    {activeDocument === 'privacy' ? (
                        <div>
                            ...
                            <p className="mb-4 text-justify">
                                Los presentesss términos y condiciones regulan el acceso y uso del sitio web www.refaccioneselboom.com (en adelante, "El Boom Tractopartes" o "el sitio web"), 
                            ...
                            {/* Más contenido del aviso de privacidad */}
