            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="rounded-2xl shadow-xl bg-white dark:bg-gray-900 border border-[#FBCC13] dark:border-[#006CFA] overflow-hidden flex flex-col transition-transform duration-200 hover:scale-[1.02]">
                    ...
                    <div className="p-6 flex flex-col gap-2">
                        ...
                        <p className="text-base text-gray-700 dark:text-gray-300 mb-2">Carretera Federal Méx- Acapulco, Km. 29, Puente de Ixtla Morelos</p>
                ...
                <div className="rounded-2xl shadow-xl bg-white dark:bg-gray-900 border border-[#FBCC13] dark:border-[#006CFA] overflow-hidden flex flex-col transition-transform duration-200 hover:scale-[1.02]">
                    ...
                    <div className="p-6 flex flex-col gap-2">
                        ...
                        <p className="text-base text-gray-700 dark:text-gray-300 mb-2">Avenida Lázaro Cárdenas, No. 2, Manzana 18. Colonia La Popular</p>
                        <div className="flex flex-wrap gap-2 items-center">
                            <span className="font-semibold">Llámanos al +52</span>
                ...
                <div className="rounded-2xl shadow-xl bg-white dark:bg-gray-900 border border-[#FBCC13] dark:border-[#006CFA] overflow-hidden flex flex-col transition-transform duration-200 hover:scale-[1.02]">
                    ...
                    <div className="p-6 flex flex-col gap-2">
                        ...
                        <p className="text-base text-gray-700 dark:text-gray-300 mb-2">Boulevard Vicente Guerrero, Km 269, Chilpancingo, Guerrero</p>
                        <div className="flex flex-wrap gap-2 items-center">
                            <span className="font-semibold">Llámanos al +52</span>
                ...
                <div className="rounded-2xl shadow-xl bg-white dark:bg-gray-900 border border-[#FBCC13] dark:border-[#006CFA] overflow-hidden flex flex-col transition-transform duration-200 hover:scale-[1.02]">
                    ...
                    <div className="p-6 flex flex-col gap-2">
                        ...
                        <p className="text-base text-gray-700 dark:text-gray-300 mb-2">Boulevard Cuauhnáhuac Km 3.5, No. 25. Colonia Buganbilias, Jiutepec, Morelos</p>
                        <div className="flex flex-wrap gap-2 items-center">
                            <span className="font-semibold">Llámanos al +52</span>
